...
#define MQTT_CLIENT     "mqttx_2cb6d785"              //Client ID（设备唯一，大家最好自行改一下）
                                        ...
                                        void* event_data)
{
    ...
    switch ((esp_mqtt_event_id_t)event_id) 
    {
        case MQTT_EVENT_CONNECTED:  //连接成功
            ...
            //连接成功后，订阅测试主题
            esp_mqtt_client_subscribe_single(s_mqtt_client,MQTT_SUBSCRIBE_TOPIC,1);  //Qos是消息服务质量
            break;
...
void app_main(void)
{
    ...
    s_wifi_ev = xEventGroupCreate();     //事件组创建
    EventBits_t ev = 0;
    ...
    while(1)
    {
        ...
        if(s_is_mqtt_connected)
        {
            ...
            esp_mqtt_client_publish(s_mqtt_client, MQTT_PUBLIC_TOPIC,    //发布
